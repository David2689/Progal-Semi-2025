...
using webappcademica.Models;

namespace webappcademica.Controllers
{
    ...
    public class DocentesController : ControllerBase
    {
        ...
        // GET: api/Docnetes
        [HttpGet("buscar")]
        public async Task<ActionResult<IEnumerable<Docente>>> BuscarDocnetes([FromQuery] DocenteBusquedaParametros parametros)
        {
        ...
        public async Task<IActionResult> PutDocente(int id, Docente docente)
        {
            ...
            return CreatedAtAction("GetDocente", new { id = docente.idDocnete }, docente);
        }
        ...
        {
            return _context.Docentes.Any(e => e.idDocnete == id);
        }
    }
}
